export default function TermsPage() {
  const lastUpdated = '08-01-2026 19:10:34';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Content */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 md:p-12 space-y-8 text-gray-700 leading-relaxed">
          {/* Introduction */}
          <section className="space-y-4">
            <p>
              ...
              <span className="font-semibold">JPK SIGNATURE SPACES LLP</span>, (
